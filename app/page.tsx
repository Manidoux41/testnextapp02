...
export default async function Home() {
  ...
  const content = (
    <>
      <Banner />
      <div className="mt-5 mb-7 p-0 lg:px-7 lg:py-10 bg-transparent lg:bg-blue-200 md:rounded-2xl w-full mx-auto flex flex-col lg:flex-row lg:flex-wrap gap-6 justify-evenly ">
        {apparts.map((appart) => (
          ...
          //   <h2 className="text-white font-medium text-lg absolute bottom-2 left-2 ">
          //     {appart.title}
          //   </h2>
          // </Link>
        ))}
